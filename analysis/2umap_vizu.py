#Define Path 
load_path = "/a/yu-yamaoka/Scientific_reports/DINO_Output/TRAIN_CP_20231201_111120_Ours4MinSize=40_Crop=64_FromPreTrainModel/epoch75_output"
save_path = load_path
data_num = 10000
...
umap_visualization(train_test_features[rand_idx][0:data_num].detach().cpu(), train_test_labels[rand_idx][0:data_num].detach().cpu(),
                    os.path.join(save_path, "train_and_test"+str(data_num)))
